...
### Added
- **CI/CD Documentation:** Documented the self-hosted GitHub Actions runner and automated deployment pipeline in `docs/project/AGENTS.md`.
...
- **Documentation Revision**: Comprehensive audit and cleanup of all documentation
  ...
  - Updated [DOCS_INDEX.md](../../DOCS_INDEX.md) with current structure
  - Added deprecation notice to docs/deployment/DEPLOY_MINT.md (legacy workflow)
...
- Full RBAC (Role-Based Access Control) implementation
  ...
  - Documentation in `docs/security/RBAC_MATRIX.md`
