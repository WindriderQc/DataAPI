...
Note: this document describes the legacy “deploy script to `/opt/servers/DataAPI`” workflow. In the current architecture, DataAPI is a headless tool server for AgentX (no UI). For the simplest setup (run from your workspace and manage in the same PM2 list as AgentX), see [README.md](../../README.md) + [QUICK_START.md](QUICK_START.md).
